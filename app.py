...
# ==========================================
# 🤖 CIVIL AI ASSISTANT (Live Google Gemini AI + 5 Sec Thinking Time)
# ==========================================
st.markdown("---")
...
if ai_lock_setting == "Free" or is_user_premium:
    ...
    user_ai_query = st.text_input("तुमचा प्रश्न किंवा शंका इथे लिहा (Type your question here):", placeholder="उदा. dry volume factor for concrete, kiti cement lagel...", key="civil_ai_input")
            ...
            with st.spinner("🤖 Civil AI is analyzing your question and calculating accurately... (कृपया ५ सेकंद वाट पाहा)"):
                ...
                if HAS_GENAI and api_key:
                    try:
                        ...
                        # Fallback to gemini-1.5-flash if 2.5 throws any model not found error
                        try:
                            response = client.models.generate_content(
                            ...
                            ai_response_text = f"⚠️ Live AI connection notice: Standard fallback activated. (Error details: {e2})"
                
                # Standard Engineering Fallback if API key is not set
