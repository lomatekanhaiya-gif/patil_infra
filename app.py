...
with st.expander("📲 मोबाईलच्या होम स्क्रीनवर ॲप कसे इन्स्टॉल करावे? (Click Here)"):
    st.markdown("""
    * **Android (Chrome):** ब्राऊझरच्या उजव्या बाजूच्या वरच्या तीन डॉट्स (`⋮`) वर क्लिक करा आणि **"Add to Home Screen"** किंवा **"Install App"** निवडा.
    * **iPhone (Safari):** खालील शेअर बटनावर (`📤`) क्लिक करून **"Add to Home Screen"** सिलेक्ट करा.
    """)
