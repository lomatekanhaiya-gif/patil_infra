...
# युझर लॉगिन/नाव विचारणे (कंडीशनल डिस्प्ले)
            ...
            if st.button("🆕 खाते तयार करा", type="primary"):
                if is_valid_email(user_email.strip()):
                    if len(user_pass) >= 4:
                        ...
                        st.error("❌ पासवर्ड किमान ४ अक्षरी असाва!")
                else:
...
# युझर इंटरफेस (नाव किंवा ईमेल व्हॅलिडेट झाल्यावरच चालणार)
if user_authorized:
    ...
    if "Concrete Work" in main_choice:
        ...
        st.write("---")
        user_comment = st.text_area("💬 **काही विशेष नोंद किंवा कमेंट लिहायची असल्यास इथे लिहा:**", placeholder="तुमची कमेंट लिहा...", key="txt_concrete")
    ...
    # ==========================================
        ...
        st.write("---")
        user_comment = st.text_area("💬 **काही विशेष नोंद किंवा कमेंट लिहायची असल्यास इथे लिहा:**", placeholder="तुमची कमेंट लिहा...", key="txt_brick")
