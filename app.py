...
"""
        ...
        # 🟢 WHATSAPP & PRINT BUTTONS (0 ERROR IMPLEMENTATION)
        msg_text = f"🏗️ *PATIL INFRATECH BBS REPORT*\n👤 *Prepared For:* {current_user_name}\n📐 *Component:* {rcc_comp}\n⚖️ *Total Weight:* {total_weight_kg:.2f} Kg ({total_weight_kg/1000:.3f} MT)\n💰 *Estimated Cost:* ₹ {total_cost:.2f}/-\n\n_A3 Size PDF Report is generated!_"
        encoded_msg = urllib.parse.quote(msg_text)
